 ...
 */
class ProfileInModal extends React.PureComponent {
    static getComponentName() {
        return 'ProfileInModal';
    }
    ...
    render() {
            ...
            dataContent.push(
                ...
                >
                    <div
                        ...
                        className='overflow--ellipsis text-nowrap center-container fullname'
                    >
        ...
        if (this.props.user.position && !haveOverrideProp) {
            ...
            dataContent.push(
                ...
                >
                    <div
                        className='overflow--ellipsis text-nowrap pt-1 pb-1 center-container'
                    >
                        {position}
                    </div>
                </OverlayTrigger>,
        ...
        if (this.props.user.status_string && !haveOverrideProp) {
            const status_string = this.props.user.status_string.substring(0, Constants.MAX_STATUS_STRING);
            dataContent.push(
                <OverlayTrigger
                    delayShow={Constants.OVERLAY_TIME_DELAY}
                    placement='top'
                    overlay={<Tooltip id='positionTooltip'>{status_string}</Tooltip>}
                    key='user-profile-modal-status_string'
                >
                    <div
                        className='overflow--ellipsis text-nowrap pt-1 pb-1 center-container status-string'
                    >
                        {status_string}
                    </div>
                </OverlayTrigger>,
        ...
        if (this.props.user.id !== this.props.currentUserId && !haveOverrideProp) {
            dataContent.push(
                <div
                    data-toggle='tooltip'
                    key='user-popover-dm'
                    className='popover__row first content-row'
                >
                    <a
                        href='#'
        ...
        title = (
            <span data-testid={`profileInModalTitle_${this.props.user.username}`}>
...
delete ProfileInModal.propTypes.id;

export default injectIntl(ProfileInModal);
