...
import {getSortedListableTeams, getTeamMemberships, getMyTeams} from 'mattermost-redux/selectors/entities/teams';
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(MyTeam));
